...
def main():
    ...
    print("\n" + "=" * 115)
    print("  DYFO CONTINUOUS DEEP REINFORCEMENT LEARNING (PPO) PERFORMANCE (10 BPS TX COST)  ")
    print("=" * 115)
    ...
    for m in models:
        ...
        print(f"{m:<28} | {res['annualized_gross_return']*100:>7.2f}% | {res['annualized_net_return']*100:>7.2f}% | {res['annualized_volatility']*100:>7.2f}% | {res['net_sharpe_ratio']:>10.4f} | {res['max_drawdown']*100:>7.2f}% | {res['turnover']:>9.4f} | {res['annualized_cost_drag_bps']:>6.1f} bps")
    print("=" * 115 + "\n")
